    ...
    _home: () => `
        ...
        <div class="features-grid">
            ...
            <div class="feature-card">
                ...
                <p>Должности полностью отделены от профессий и созданы для управления жизнью города. Вы можете быть Лесорубом, но при этом занимать пост Шерифа, или Шахтёром, который ночью лечит людей. Выбери свое призвание.</p>
            </div>
            <div class="feature-card">
                <span class="feature-icon">🎨</span>
